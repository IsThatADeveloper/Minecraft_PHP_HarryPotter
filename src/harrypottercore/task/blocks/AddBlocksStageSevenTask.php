...
class AddBlocksStageSevenTask extends PluginTask {
	...
	*/
	...
	public function onRun(int $currentTick): void {
	       ...
	       $pk->volume = 3;
	       $pk->pitch = 2;
	       $pk->soundName = 'note.iron_xylophone';
	       ...
	       //top to bottom ->
	       //rows not added
	       $pos1 = new Position(("-330"), (4), (117));
	       $pos2 = new Position(("-330"), (5), (117));
	       $pos3 = new Position(("-330"), (6), (117));
	       $pos4 = new Position(("-330"), (7), (117));
	       $pos5 = new Position(("-330"), (8), (117));
	       $pos6 = new Position(("-331"), (4), (117));
	       $pos7 = new Position(("-331"), (5), (117));
	       $pos8 = new Position(("-331"), (6), (117));
	       $pos9 = new Position(("-331"), (7), (117));
	       $pos10 = new Position(("-331"), (8), (117));
	       $pos11 = new Position(("-332"), (4), (117));
	       $pos12 = new Position(("-332"), (5), (117));
	       $pos13 = new Position(("-332"), (6), (117));
	       $pos14 = new Position(("-332"), (7), (117));
	       $pos15 = new Position(("-332"), (8), (117));
	       $pos16 = new Position(("-333"), (4), (117));
	       $pos17 = new Position(("-333"), (5), (117));
	       $pos18 = new Position(("-333"), (6), (117));
	       $pos19 = new Position(("-333"), (7), (117));
	       $pos20 = new Position(("-333"), (8), (117));
	       $pos21 = new Position(("-334"), (4), (117));
	       $pos22 = new Position(("-334"), (5), (117));
	       $pos23 = new Position(("-334"), (6), (117));
	       $pos24 = new Position(("-334"), (7), (117));
	       $pos25 = new Position(("-334"), (8), (117));
	       $pos26 = new Position(("-335"), (4), (117));
	       $pos27 = new Position(("-335"), (5), (117));
	       $pos28 = new Position(("-335"), (6), (117));
	       $pos29 = new Position(("-335"), (7), (117));
	       $pos30 = new Position(("-335"), (8), (117));
	       ...
	       $level->setBlock($pos1, $air, true, true);
	       $level->setBlock($pos2, $air, true, true);
	       $level->setBlock($pos3, $air, true, true);
	       $level->setBlock($pos4, $air, true, true);
	       $level->setBlock($pos5, $air, true, true);
	       $level->setBlock($pos6, $air, true, true);
	       $level->setBlock($pos7, $air, true, true);
	       $level->setBlock($pos8, $air, true, true);
	       $level->setBlock($pos9, $air, true, true);
	       $level->setBlock($pos10, $air, true, true);
	       $level->setBlock($pos11, $air, true, true);
	       ...
	       $level->setBlock($pos16, $air, true, true);
	       ...
	       $level->setBlock($pos21, $air, true, true);
	       $level->setBlock($pos22, $air, true, true);
	       $level->setBlock($pos23, $air, true, true);
	       $level->setBlock($pos24, $air, true, true);
	       $level->setBlock($pos25, $air, true, true);
	       $level->setBlock($pos26, $air, true, true);
	       $level->setBlock($pos27, $air, true, true);
	       $level->setBlock($pos28, $air, true, true);
	       $level->setBlock($pos29, $air, true, true);
	       $level->setBlock($pos30, $air, true, true);
	}
}
