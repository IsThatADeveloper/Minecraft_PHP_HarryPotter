...
class AddBlocksStageFourTask extends PluginTask {
	...
	*/
	...
	public function onRun(int $currentTick): void {
	       ...
	       $pos7 = new Position(("-331"), (5), (117), $level); //stairupright
	       $pos8 = new Position(("-331"), (6), (117), $level);
	       $pos9 = new Position(("-331"), (7), (117), $level); //air
	       $pos10 = new Position(("-331"), (8), (117), $level);
	       //row 3
	       $pos11 = new Position(("-332"), (4), (117), $level);
	       $pos12 = new Position(("-332"), (5), (117), $level); //air
	       $pos13 = new Position(("-332"), (6), (117), $level); //air
	       $pos14 = new Position(("-332"), (7.5), (117), $level); //slab
	       $pos15 = new Position(("-332"), (8), (117), $level);
	       //row 4
	       $pos16 = new Position(("-333"), (4), (117), $level);
	       $pos17 = new Position(("-333"), (5), (117), $level); //air
	       $pos18 = new Position(("-333"), (6), (117), $level); //air
	       $pos19 = new Position(("-333"), (7), (117), $level); //air
	       $pos20 = new Position(("-333"), (8), (117), $level);
	       //row 5
	       $pos21 = new Position(("-334"), (4), (117), $level); //stairupleft
	       $pos22 = new Position(("-334"), (5), (117), $level); //air
	       $pos23 = new Position(("-334"), (6), (117), $level); //stairdownleft
	       ...
	       $level->setBlock($pos7, $stairupr, true, true); //stairupright
	       $level->setBlock($pos8, $brick, true, true);
	       $level->setBlock($pos9, $air, true, true); //air
	       $level->setBlock($pos10, $brick, true, true);
	       //row 3
	       $level->setBlock($pos11, $brick, true, true);
	       $level->setBlock($pos12, $air, true, true); //air
	       ...
	       $level->setBlock($pos17, $air, true, true); //air
	       $level->setBlock($pos18, $air, true, true); //air
	       $level->setBlock($pos19, $air, true, true); //air
	       $level->setBlock($pos20, $brick, true, true);
	       //row 5
	       $level->setBlock($pos21, $brick, true, true);
	       $level->setBlock($pos22, $stairupl, true, true); //stairupleft
	       $level->setBlock($pos23, $air, true, true); //air
	       $level->setBlock($pos24, $stairdownl, true, true); //stairdownleft
