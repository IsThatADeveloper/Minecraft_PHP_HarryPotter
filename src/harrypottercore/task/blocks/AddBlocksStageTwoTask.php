...
class AddBlocksStageTwoTask extends PluginTask {
	...
	//$corner1 = Block::get($this->corner,1); 1 = int down
	...
	*/
	...
	public function onRun(int $currentTick): void {
	       ...
	       $stairupr = Block::get(Block::BRICK_STAIRS,0);
               $slab = BlockFactory::get(Block::STONE_SLAB,5); //brick slabs
	       ...
	       $level->setBlock($pos9, $brick, true, true);
	       $level->setBlock($pos10, $brick, true, true);
	       $level->setBlock($pos11, $brick, true, true);
	       $level->setBlock($pos12, $brick, true, true);
	       $level->setBlock($pos13, $stairupr, true, true);
	       $level->setBlock($pos14, $brick, true, true);
	       $level->setBlock($pos15, $brick, true, true);
	       $level->setBlock($pos16, $brick, true, true);
	       $level->setBlock($pos17, $brick, true, true);
	       $level->setBlock($pos18, $stairdownl, true, true);
	       $level->setBlock($pos19, $brick, true, true);
	       $level->setBlock($pos20, $brick, true, true);
	       $level->setBlock($pos21, $brick, true, true);
	       $level->setBlock($pos22, $brick, true, true);
	       $level->setBlock($pos23, $brick, true, true);
