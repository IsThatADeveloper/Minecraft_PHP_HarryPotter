...
class AddBlocksStageSixTask extends PluginTask {
	...
	*/
	...
	public function onRun(int $currentTick): void {
	       ...
	       //row 2
	       $pos6 = new Position(("-331"), (4), (117), $level); //stairupright
	       ...
	       $pos25 = new Position(("-334"), (8.5), (117), $level); //slab
	       //row 6
	       ...
	       //row 2
	       $level->setBlock($pos6, $stairupr, true, true); //stairupright
	       ...
	       $level->setBlock($pos25, $slab, true, true); //slab
	       //row 6
