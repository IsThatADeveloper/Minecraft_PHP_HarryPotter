...
class AddBlocksStageThreeTask extends PluginTask {
	...
	*/
	...
	public function onRun(int $currentTick): void {
	       ...
	       $stairdownl = Block::get(Block::BRICK_STAIRS,5); //side down, face left
	       $stairdownr = Block::get(Block::BRICK_STAIRS,4); //side down, face right
	       $stairupl = Block::get(Block::BRICK_STAIRS,1); //side up, face left
	       $stairupr = Block::get(Block::BRICK_STAIRS,0); //side up, face right
               $slab = Block::get(Block::STONE_SLAB,5); //brick slabs
               $air = BlockFactory::get(Block::AIR);
	       //top to bottom ->
	       //row 1 
	       $pos1 = new Position(("-330"), (4), (117), $level);
	       $pos2 = new Position(("-330"), (5), (117), $level);
	       $pos3 = new Position(("-330"), (6), (117), $level);
	       $pos4 = new Position(("-330"), (7), (117), $level);
	       $pos5 = new Position(("-330"), (8), (117), $level); 
	       //row 2
	       $pos6 = new Position(("-331"), (4), (117), $level);
	       $pos7 = new Position(("-331"), (5), (117), $level);
	       $pos8 = new Position(("-331"), (6), (117), $level);
	       $pos9 = new Position(("-331"), (7.5), (117), $level); //slab
	       $pos10 = new Position(("-331"), (8), (117), $level);
	       //row 3
	       $pos11 = new Position(("-332"), (4), (117), $level);
	       $pos12 = new Position(("-332"), (5.5), (117), $level); //slab
	       $pos13 = new Position(("-332"), (6), (117), $level); //air
	       $pos14 = new Position(("-332"), (7), (117), $level); //slab
	       $pos15 = new Position(("-332"), (8), (117), $level); 
	       //row 4
	       $pos16 = new Position(("-333"), (4), (117), $level); 
	       $pos17 = new Position(("-333"), (5), (117), $level); //stairdownleft
	       $pos18 = new Position(("-333"), (6), (117), $level); //air
	       $pos19 = new Position(("-333"), (7), (117), $level); //slab
	       $pos20 = new Position(("-333"), (8), (117), $level);
	       //row 5
	       $pos21 = new Position(("-334"), (4), (117), $level);
	       $pos22 = new Position(("-334"), (5), (117), $level);
	       $pos23 = new Position(("-334"), (6), (117), $level); //slab
	       $pos24 = new Position(("-334"), (7), (117), $level);
	       $pos25 = new Position(("-334"), (8), (117), $level);
	       //row 6
	       $pos26 = new Position(("-335"), (4), (117), $level);
	       $pos27 = new Position(("-335"), (5), (117), $level);
	       $pos28 = new Position(("-335"), (6), (117), $level);
	       $pos29 = new Position(("-335"), (7), (117), $level);
	       $pos30 = new Position(("-335"), (8), (117), $level);
	       ...
	       $level->setBlock($pos1, $brick, true, true);
	       $level->setBlock($pos2, $brick, true, true);
	       $level->setBlock($pos3, $brick, true, true);
	       $level->setBlock($pos4, $brick, true, true);
	       $level->setBlock($pos5, $brick, true, true);
	       $level->setBlock($pos6, $brick, true, true);
	       $level->setBlock($pos7, $brick, true, true);
	       $level->setBlock($pos8, $brick, true, true);
	       $level->setBlock($pos9, $slab, true, true); //slab
	       $level->setBlock($pos10, $brick, true, true);
	       $level->setBlock($pos11, $brick, true, true);
	       $level->setBlock($pos12, $slab, true, true); //slab
	       $level->setBlock($pos13, $air, true, true); //air
	       $level->setBlock($pos14, $slab, true, true); //slab
	       $level->setBlock($pos15, $brick, true, true);
	       $level->setBlock($pos16, $brick, true, true);
	       $level->setBlock($pos17, $stairdownl, true, true); //stairdownleft
	       $level->setBlock($pos18, $air, true, true); //air 
	       $level->setBlock($pos19, $slab, true, true); //slab
	       $level->setBlock($pos20, $brick, true, true);
	       $level->setBlock($pos21, $brick, true, true);
	       $level->setBlock($pos22, $brick, true, true);
	       $level->setBlock($pos23, $air, true, true); //air
	       $level->setBlock($pos24, $brick, true, true);
	       $level->setBlock($pos25, $brick, true, true);
	       $level->setBlock($pos26, $brick, true, true);
	       $level->setBlock($pos27, $brick, true, true);
	       $level->setBlock($pos28, $brick, true, true);
	       $level->setBlock($pos29, $brick, true, true);
	       $level->setBlock($pos30, $brick, true, true);
	}
}
